...
public class ComicFileFilter extends FileFilter {
     ...
     * @see #addExtension
     */
    public ComicFileFilter(String extension) {
	this(extension,null);
    }
     ...
     * @see #addExtension
     */
    public ComicFileFilter(String extension, String description) {
	this();
     ...
     * @see #addExtension
     */
    public ComicFileFilter(String[] filters) {
	this(filters, null);
    }
     ...
     * @see #addExtension
     */
    public ComicFileFilter(String[] filters, String description) {
	this();
